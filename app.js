...
The time between the first day of one period and the day before the start of the next is called a menstrual cycle. However, it can vary greatly when a girl first starts her period. It may skip months or come several times per month in the beginning. The first day of the menstrual cycle starts with your period, the release of blood from the vagina, which can last from 2 to 10 days.`,String.raw`Will every day of my period be the same? <br>
...
`,String.raw`Does having your period hurt? <br>

Menstruation itself doesn’t hurt, but some girls and women get cramps or other symptoms during their periods that may be uncomfortable. This is typically due to the hormones your body releases during menstruation that cause the uterus to contract so it can shed its lining. Some amount of discomfort like pain in the abdomen, backache, headaches are common, if it becomes severe it can be controlled by using heating pads, resting, drinking lots of fluids and pain medicines if needed.`,String.raw`What if your periods start at school or somewhere else? <br>

Keep a pad and a clean pair of underwear in your backpack or purse, so you are always prepared. If you are at school, take help from your teachers or school nurses. If you’re out somewhere else, give a call to your mother, elder sister or aunt.`,String.raw`What is PMS? <br>
